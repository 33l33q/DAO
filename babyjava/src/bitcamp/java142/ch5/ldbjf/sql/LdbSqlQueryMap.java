...
public abstract class LdbSqlQueryMap {
	...
	public static final	String M1_LDB_MEMBER_LMEM_CHEABUM =
			" SELECT /*+ INDEX_DESC(A.SYS_C0011185)  */ "
       +" NVL(MAX(SUBSTR(A.LMEM, -4)) , 0) + 1 COMMNO FROM M1_LDB_MEMBER A";
